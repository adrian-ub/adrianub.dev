...
```angular-ts title="rating-input.component.ts"
...
```angular-html title="app.component.html"
...
```angular-ts title="rating-input.component.ts" "CONTROL_VALUE_ACCESSOR"
...
```angular-html "[disabled]" "[(ngModel)]" "formControlName" title="app.component.html"
